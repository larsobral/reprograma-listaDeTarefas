...
mongoose.connect("mongodb://localhost:27017/to-do-list", { // no nosso caso nao temos usuario e senha, mas caso tivessemos poderiamos seguir esse formato: mongodb://username:password@localhost:27017/reprograma-trip
...
//Rotas
const travelsRoutes = require("./routes/listroutes");
